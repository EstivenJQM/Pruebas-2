...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4><i class="bi bi-diagram-2 me-2"></i>Nueva Línea</h4>
                ...
                <select name="id_componente"
                    ...
                    @foreach($componentes as $comp)
                        <option value="{{ $comp->id_componente }}"
                            {{ old('id_componente') == $comp->id_componente ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input"
                           ...
                           {{ in_array($tipo->id_tipo_actividad, old('tipos_actividad', [])) ? 'checked' : '' }}>
